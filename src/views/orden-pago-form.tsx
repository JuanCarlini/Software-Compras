...
// después redirige al detalle.
//
// Migrado a RHF+Zod (2026-07-22, patrón híbrido = certificacion-form): la CABECERA (proveedor,
// moneda, fecha) va por react-hook-form + zodResolver (validación de campo + a11y). Las
// facturas pagables y las cajas se traen del backend → estado controlado; sus validaciones
// (>=1 factura, Σcajas = Σfacturas) van a form root; el gate real es fn_op_gate (422).
